...
<div class="container mt-5 border border-1">
    <div class="container">
        ...
        <form:form action="/employees/saveEmployee" method="post" cssClass="row g-3" modelAttribute="employee">
            ...
            <div class="col-6">
                ...
                <div class="form-check form-check-inline">
                    <form:checkbox path="programmingLanguage" cssClass="form-check-input" value="Ruby"/>
            ...
            <div class="col-6">
                ...
                <form:select path="department" cssClass="form-select">
            ...
            <div class="col-6">
                <form:label path="role" cssClass="form-label fw-bold">Role</form:label>
                <form:select path="role" cssClass="form-select">
                    <form:option value="">----------Select Role----------</form:option>
                    <form:options items="${roleList}" itemValue="roleId" itemLabel="roleType"/>
                </form:select>
